...
class GetMoreBaseExperiencePokemonUseCaseTest {
    ...
    @Test
    public void getMoreBaseExperiencePokemon_calls_update_and_getAll_ok() {
        ...
        var pk6 = Pokemon.builder().id(6).name("f").baseExperience(6).build();
        var pk7 = Pokemon.builder().id(7).name("g").baseExperience(7).build();
        ...
        var results = getMoreBaseExperiencePokemonUseCase.getMoreBaseExperiencePokemon().collectList().block();
    ...
    @Test
    public void getMoreBaseExperiencePokemon_less_than_five() {
    ...
    @Test
    public void getMoreBaseExperiencePokemon_without_pokemon() {
